...
* `trace_id` - идентификатор трассировки. Если не указано, устанавливается из заголовка [traceparent](https://www.w3.org/TR/trace-context/#traceparent-header) при его наличии.
